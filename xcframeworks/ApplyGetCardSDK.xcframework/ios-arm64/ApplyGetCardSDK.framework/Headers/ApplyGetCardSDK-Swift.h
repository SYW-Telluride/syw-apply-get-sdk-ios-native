...
#ifndef APPLYGETCARDSDK_SWIFT_H
#define APPLYGETCARDSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ApplyGetCardSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSCoder;
SWIFT_CLASS("_TtC15ApplyGetCardSDK12AGCComponent")
@interface AGCComponent : UIView
...
@class UIScrollView;
@interface AGCComponent (SWIFT_EXTENSION(ApplyGetCardSDK)) <UIScrollViewDelegate>
